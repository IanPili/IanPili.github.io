    ...
    if(wScrollProperties.initialize) {
        ...
        if(canMove) {
            ...
            if(!wScrollProperties.isAuto){
                ...
                w(wScrollConfig.barId).changeStyle('transform;transition',  'translate(' + wScrollConfig.barX + 'px, ' + wScrollProperties.newBarY + 'px) rotate(0deg);transform .6s linear');
                w(wScrollConfig.contentId).changeStyle('transform;transition',  'translate(' + wScrollConfig.contentX + 'px, ' + wScrollProperties.newContentY + 'px) rotate(0deg);transform .6s linear');
            }
        }
    }
}
